...
# --- TAB 2: 2026 SIMULATION ---
    ...
    col1.metric("BJP Seats", (df_sim['Winner'] == 'BJP').sum())
    col2.metric("TMC Seats", (df_sim['Winner'] == 'TMC').sum())
    col3.metric("Lead Margin", (df_sim['Winner'] == 'BJP').sum() - (df_sim['Winner'] == 'TMC').sum())
